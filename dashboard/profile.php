    ...
    <div class="container">
        <div class="menu">
            <form method="post">
                ...
                <input type="submit" name="deposit_history" value="Deposit History">
                <input type="submit" name="withdraw" value="Withdraw">
                <input type="submit" name="withdraw_history" value="Withdraw History">
            ...
            if (isset($_POST['signout'])) {
                ...
                exit;
            } else if (isset($_POST['deposit_history'])) {
