...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="recive">
                <div class="txt">
                    <h2>Please Scan Qr or Tell Sender to Send Coin to Your User ID</h2>
                    <p>User ID is: <?php echo $userId ?></p>
                </div>
                <div class="qr">
                    <?php
                    ...
                    echo "<img src='https://api.qrserver.com/v1/create-qr-code/?data={$userId}&amp;size=200x200' alt='QR Code'>";
                    ?>
                </div>
